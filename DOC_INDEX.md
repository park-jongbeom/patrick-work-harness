# DOC_INDEX — patrick-work-harness
...
| FEATURE_SPEC.md | 2 | Gate A | Skeleton |
| API_SPEC.md | 2 | Gate C | Skeleton |
| TEST_PLAN.md | 2 | Gate C–D | Skeleton |
| ERROR_HANDLING.md | 2 | Gate D | Skeleton |
| DECISION_LOG.md | 2 | All gates (ADR) | Skeleton |
